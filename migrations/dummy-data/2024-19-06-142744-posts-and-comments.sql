...
VALUES ('Discovering the Eccentric Vogons', 'Vogons are known not just for their bureaucratic obsession but also for their dreadful poetry. This post explores the peculiar culture of Vogons, their love for paperwork, and why they are considered the third worst poets in the Universe.', '2008-05-01 12:00:00'),
       ('The Secrets of the Pan Galactic Gargle Blaster', 'The Pan Galactic Gargle Blaster is known as the best drink in existence. This post delves into its zesty components, the effects of its consumption, and why it should be drunk with caution. Remember, the effect is similar to having your brains smashed out by a slice of lemon wrapped round a large gold brick.', '2008-04-01 12:00:00'),
       ('Marvin’s Guide to Coping with Existence', 'Life? Don’t talk to me about life! This post explores Marvin the Paranoid Android’s views on existence, detailing his journey through space with his depressingly funny insights and why his processors ache so much.', '2008-03-01 12:00:00'),
       ('Exploring the Infinite Improbability Drive', 'The Infinite Improbability Drive is a wonderful new method of crossing vast interstellar distances in a mere nothingth of a second without all that tedious mucking about in hyperspace. This post explains how this remarkable technology works and the bizarre occurrences that happen when it’s activated.', '2008-06-01 12:00:00'),
       ('Why Earth is Mostly Harmless', 'According to "The Hitchhiker’s Guide to the Galaxy", Earth is described as mostly harmless. This post examines what led to such a minimalistic description and what implications it might have for future intergalactic hitchhikers looking for a quick guide to the galaxy.', '2008-02-01 12:00:00');

INSERT INTO comments (post_id, name, email, content, created_at)
VALUES (1, 'Zaphod Beeblebrox', NULL, 'Never could get the hang of Vogons. Tried to party with them once, but all they wanted to do was file reports. What a snooze fest!', '2008-06-15 14:23:52'),
